...
case 'CLA':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(106,55,200,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
case 'FRB':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(80,206,71,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
case 'HBL':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(209,55,127,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
